    ...
    <div className="w-full max-w-2xl mx-auto mb-12">
      <div className="text-center mb-8">
        ...
        <p className="text-github-secondary text-base sm:text-lg px-2 max-w-xl mx-auto">
          Enrique is here! The fastest way to generate high-quality GitHub issues. Streamline your open source contributions and get ready to earn rewards on <strong>Lightning Bounties</strong>.
        </p>
      </div>
